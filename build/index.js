...
const openapi_parser_js_1 = require("./openapi-parser.js");
...
const oasPath = path_1.default.join(__dirname, "./", "data/paystack.openapi.yaml");
const openapi = new openapi_parser_js_1.OpenAPIParser(oasPath);
// @ts-ignore
...
server.registerTool("get_operation_guided", {
...
server.registerResource("operation-list", new mcp_js_1.ResourceTemplate("openapi://operations/list", { list: undefined }), {
